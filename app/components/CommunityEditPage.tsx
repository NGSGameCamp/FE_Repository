  ...
  return (
    <div className="container mx-auto px-6 py-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">로컬 저장 데모 — 저장 후 전체 글 페이지로 이동합니다.</p>
      </div>
      ...
      <Card className="border-primary/20 mx-auto" style={{ maxWidth: 900 }}>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea rows={12} value={content} onChange={(e) => setContent(e.target.value)} placeholder="내용을 수정하세요" />
          </div>
